...
- 0.5.0: 添加地图标记功能，支持在地图上添加、编辑、删除自定义标记；添加足迹记录功能；添加坐标转换工具
- 0.5.1: 代码架构优化，移除未使用的导入；性能改进
- 0.6.0: 地图标注分类管理、轨迹统计分析、数据导出
- 0.7.0: 离线地图区域管理、热点POI推荐、地图快照保存功能
- 0.7.1: 代码架构优化和UI细节打磨

### 0.3.0-0.4.1 (早期版本)
- 0.3.0: 折叠屏/平板适配、120Hz高刷新率、收藏夹管理优化
- 0.3.1: 修复 onLocationSelected 回调函数类型不匹配问题
- 0.4.0: 地图图层切换、指南针和比例尺、距离测量、位置分享
- 0.4.1: 修复 Straighten 图标引用错误和类型不匹配问题

### 0.1.0-0.2.0 (早期版本)
- 0.1.0: 初始版本发布，包含地图显示、位置定位、地点搜索、收藏夹管理、路线规划、设置功能
- 0.1.1: 修复 SwapVert 图标引用错误
- 0.2.0: 新增地图旋转手势支持（双指旋转）
